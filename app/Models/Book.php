 ...
 * how the library classifies it. It is deliberately NOT a physical item —
 * copies (accession numbers, shelf location, condition, availability) are a
 * Phase 2 concern and will reference this model. Nothing on a Book can be
 * issued, returned, renewed or fined.
 *
