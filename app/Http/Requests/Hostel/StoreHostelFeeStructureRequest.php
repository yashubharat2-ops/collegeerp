...
class StoreHostelFeeStructureRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', HostelFeeStructure::class) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('hostel_fee_structures', 'code')->where('college_id', $collegeId),
            ],
