...
class VacateHostelAllocationRequest extends FormRequest
{
    ...
    {
        return [
            'vacated_date' => ['required', 'date', 'after_or_equal:today', 'after_or_equal:allocation_date'],
    ...
    {
        return [
            'vacated_date.after_or_equal' => 'The vacated date must not be earlier than the allocation date.',
        ];
    }
}
