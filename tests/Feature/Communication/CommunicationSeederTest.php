...
class CommunicationSeederTest extends TestCase
{
    ...
    {
        // Phase 2 (communication_templates.*, communication_logs.view,
        // communication_tracking.view, communication_reports.view) is covered
        // by CommunicationPhase2SeederTest; external gateways remain future
        // phases and must still not be seeded.
        foreach ([
            'sms.view', 'sms.send', 'sms_gateway.view', 'email_gateway.view', 'whatsapp.view',
            'sms_templates.view', 'email_templates.view', 'delivery_logs.view',
        ] as $slug) {
