...
trait CampusTestHelpers
{
    ...
    private function makeUserWithPermissions(College $college, array $slugs, bool $superAdmin = false): User
    {
        ...
        $role = Role::create(['college_id' => $superAdmin ? null : $college->id, 'name' => $college->code.' Campus Role', 'slug' => 'campus-role-'.strtolower($college->code).'-'.Str::random(4), 'is_system' => false, 'is_active' => true]);
        if ($slugs) {
