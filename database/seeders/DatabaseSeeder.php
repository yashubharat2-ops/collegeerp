...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = collect(['dashboard.view', 'colleges.view', 'colleges.update', 'campuses.view', 'campuses.create', 'campuses.update', 'campuses.delete', 'departments.view', 'departments.create', 'departments.update', 'departments.delete', 'academic-years.view', 'academic-years.create', 'academic-years.update', 'programs.view', 'programs.create', 'programs.update', 'programs.delete', 'settings.view', 'settings.update', 'roles.view', 'roles.update', 'permissions.view'])->mapWithKeys(fn ($slug) => [$slug => Permission::firstOrCreate(['slug' => $slug], ['name' => Str::headline($slug), 'module' => Str::before($slug, '.'), 'action' => Str::after($slug, '.')])]);
